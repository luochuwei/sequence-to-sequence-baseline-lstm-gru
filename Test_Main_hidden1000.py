...
for i in xrange(2000):
    ...
    for get_num_start in xrange((full_data_len/read_data_batch)+1):
        ...
        l3,r3 = model.predict(data_4[0][0], data_4[0][1],data_4[0][3], data_4[0][5], batch_size)
        #打印结果
        print "left : "
        ...
        if read_data_batch_error < g_error:
            ...
            save_model("testFANN10000_batch1000_best.model", model)
...
print "save model..."
save_model("testFANN10000_batch1000_final.model", model)
