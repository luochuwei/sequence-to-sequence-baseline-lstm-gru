...
x_path = "data/train-dev.txt"
y_path = "data/test-dev.txt"
...
X_seqs, y_seqs, i2w, w2i, tf, data_x_y = get_data.processing(x_path, y_path, threshold, 0, 4, batch_size)
...
for i in xrange(5000):
    ...
    for batch_id, xy in data_x_y.items():
        ...
        cost, sents, t, test, test2, test3, test4, test5, test6, test7 = model.train(X, Y, mask, mask_y, lr, local_batch_size)
        error += cost
        break
