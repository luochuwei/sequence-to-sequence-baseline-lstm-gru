...
load_model("data/1-GRU-8000-hidden1000_best.model", model)
...
for i in xrange(10000):
    ...
    E = error/float(full_data_len/read_data_batch)
    if E < g_error:
        g_error = E
        print 'new smaller cost, save param...'
        save_model("GRU-8000-hidden1000_best.model", model)
    # if error < 3.0:
    ...
    print "train_last :"
    get_data.print_sentence_last_n(sents, dim_y, i2w, 5)
...
print "save model..."
save_model("GRU-8000-hidden1000_best-final.model", model)
