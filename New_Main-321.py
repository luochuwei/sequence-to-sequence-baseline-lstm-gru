...
load_model("GRU-8000_best.model", model)
...
for i in xrange(5000):
    ...
    if error < g_error:
        ...
        save_model("GRU-8000_best.model", model)
    if error < 3.0:
    ...
    print i, 'iter', "cost is ", error/(full_data_len/read_data_batch)
    print "train_last :"
    get_data.print_sentence_last_n(sents, dim_y, i2w, 2)
...
print "save model..."
save_model("GRU-8000_best-final.model", model)
