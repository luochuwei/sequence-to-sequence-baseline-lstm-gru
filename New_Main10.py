...
xs, yls, yrs, i2w, w2i, tf, data_4 = get_data.processing(x_path, y_left_path, y_right_path, threshold, 8, 9, 1)
# xs4, yls4, yrs4, i2w4, w2i4, tf4, data_t1 = get_data.processing(x_path, y_left_path, y_right_path, threshold, 15, 16, 1)
# xs4, yls4, yrs4, i2w4, w2i4, tf4, data_t2 = get_data.processing(x_path, y_left_path, y_right_path, threshold, 1001, 1002, 1)
...
# print "save data dic..."
# save_data_dic("data/i2w6.pkl", "data/w2i10000.pkl", i2w, w2i)
...
for i in xrange(2000):
    ...
    for get_num_start in xrange((full_data_len/read_data_batch)+1):
        ...
        if read_data_batch_error < g_error:
            ...
            # save_model("FANN1000.model", model)
